      ...
      <div className="admin-app">
        <aside className="admin-sidebar">
          ...
          <nav className="admin-nav-section">
            ...
            <AdminNavItem href="/admin/partners" icon="fa-solid fa-handshake" label="Partenaires" />
          ...
          <nav className="admin-nav-section">
            ...
            <AdminNavItem href="/admin/media" icon="fa-solid fa-images" label="Médiathèque" />
            <AdminNavItem href="/admin/galerie" icon="fa-solid fa-camera" label="Galerie photos" />
